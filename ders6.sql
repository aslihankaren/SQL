...
-- NOT GROUP BY ILE GRUPLAMA YAPILDIGINDA  SELECTEN SONRA SADECE GRUPLANAN SUTUN KULLANILABILIR
-- YA DA BASKA BIR SÜTUNUN AGGRGATE FONK ILE HESAPLAMASI KULLANILABILIR

select isim, urun_adi -- HATA
from manav
group by isim;


--ürün ismine göre her bir ürünü alan toplam kişi sayısı gösteriniz. bir müsteri lazim bu sebeple farkli isimleri sayiyoruz
...
select urun_miktar, count(id) as musteri_sayisi
from manav
...
INSERT INTO developers(name,email,salary,prog_lang,city,age) VALUES('Osman','osman@mail.com',4000,'Java','Ankara',28);
INSERT INTO developers(name,email,salary,prog_lang,city,age) VALUES('Gokhan','gokhan@mail.com',5000,'JavaScript','Istanbul',35);
INSERT INTO developers(name,email,salary,prog_lang,city,age) VALUES('Aslihan','aslihan@mail.com',5000,'Java','Izmir',38);
INSERT INTO developers(name,email,salary,prog_lang,city,age) VALUES('Ahmet','ahmet@mail.com',4000,'JavaScript','Istanbul',32);
...
--not: union veya union all ile birlestirdigimiz sorgular 
--1: ayni sayida sütunu gostermeli
--2: alt alta gelecek sütunlar ayni data tipinde olmali
...
select sehir , maas from testers where isyeri='Vakko'
union
select city as sehir, salary from developers where prog_lang='Java'
...
select city from developers -- konya
except
select sehir from testers



select sehir from testers --antalya /
except
select city from developers
